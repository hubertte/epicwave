    ...
    function getDependencyProposals() {
        return [
            ...
            },
            {
                ...
                kind: monaco.languages.CompletionItemKind.Snippet,
                insertText: 'InfYeld()',
                detail: 'Starts Infinite Yeld (EpicWave Function)',
                documentation: 'Starts Infinite Yeld (EpicWave Function) An fe Admin Panel'
            },
            {
                label: 'if ... then',
                kind: monaco.languages.CompletionItemKind.Snippet,
...
monaco.editor.defineTheme('myCustomTheme', {
    base: 'vs', // You can also use 'vs-dark' or 'hc-black' as the base theme
    inherit: true,
    rules: [
      { token: '', foreground: '141414' } // Set the default text color to #141414
    ],
    colors: {
      'editor.foreground': '#141414', // Set editor text color to #141414
      'editor.background': '#FFFFFF' // Set background color to white (optional)
    }
  });
...
monaco.editor.defineTheme('myDarkTheme', {
    ...
    colors: {
      ...
      "editorHoverWidget.background": "#191919",       // Background color of the hover widget
      ...
      "editorSuggestWidget.background": "#191919",     // Background for IntelliSense suggestions
      ...
      "editorSuggestWidget.border": "#3a3d41",         // Border color for IntelliSense suggestions popup
      
      // Tooltip and parameter info highlight colors
      "editorHoverWidget.highlightForeground": "#ffffff",  // Highlight color for important text in tooltips
      "editorSuggestWidget.selectedForeground": "#ffffff"  // Foreground (text) color for the selected item in IntelliSense
    }
  });
    ...
    editor = monaco.editor.create(document.getElementById("container"), {
        value: `-- Epic Wave https://discord.gg/WpdKb946aX`,
        language: 'lua',
        theme: 'myDarkTheme',
